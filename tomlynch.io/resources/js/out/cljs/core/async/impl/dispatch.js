...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_20303 = 0;while(true){
var m_20304 = cljs.core.async.impl.dispatch.tasks.pop();if((m_20304 == null))
{} else
{m_20304.call(null);
if((count_20303 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__20305 = (count_20303 + 1);
count_20303 = G__20305;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__9114__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__9114__auto__)
