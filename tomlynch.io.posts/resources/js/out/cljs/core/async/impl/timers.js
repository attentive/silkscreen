...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__9693__auto__,writer__9694__auto__,opt__9695__auto__){return cljs.core._write.call(null,writer__9694__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_20268 = 0;while(true){
if((i_20268 < arr.length))
{(arr[i_20268] = null);
{
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__9693__auto__,writer__9694__auto__,opt__9695__auto__){return cljs.core._write.call(null,writer__9694__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_20275 = (self__.level + 1);while(true){
if((i_20275 <= (new_level + 1)))
{(update[i_20275] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_20277 = 0;while(true){
if((i_20277 <= self__.level))
{var links_20278 = (update[i_20277]).forward;if(((links_20278[i_20277]) === x__$1))
{(links_20278[i_20277] = (x__$1.forward[i_20277]));
{
var G__20279 = (i_20277 + 1);
i_20277 = G__20279;
continue;
}
} else
{{
var G__20280 = (i_20277 + 1);
i_20277 = G__20280;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__9126__auto__ = (cljs.core.truth_((function (){var and__9114__auto__ = me;if(cljs.core.truth_(and__9114__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__9114__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__9126__auto__))
...
cljs.core.async.impl.dispatch.queue_delay.call(null,((function (timeout_channel,or__9126__auto__,timeout__$1,me){
return (function (){cljs.core.async.impl.timers.timeouts_map.remove(timeout__$1);
return cljs.core.async.impl.protocols.close_BANG_.call(null,timeout_channel);
});})(timeout_channel,or__9126__auto__,timeout__$1,me))
,msecs);
